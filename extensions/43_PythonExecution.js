    ...
    class PythonExecution {
        constructor() {
            ...
            this.executePythonCode = async (args) => {
                ...
                try {
                    this.output = '';  
                    this.pyodide.globals.set('print', this.createPythonPrintHandler());  
                ...
                return new Promise((resolve) => {
                    ...
                    input.onchange = async (event) => {
                        ...
                        if (file) {
                            ...
                            const output = await this.executePythonCode({ code: text }); 
                            resolve(output);  
                        } else {
            ...
            this.executePythonFromURL = async (args) => {
                ...
                try {
                    ...
                    const output = await this.executePythonCode({ code }); 
                    return output;  
                } catch (error) {
